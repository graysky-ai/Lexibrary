...
**Summary:** Async LLM service that generates design files via BAML, with provider routing and rate limiting.

## Interface

| Name | Signature | Purpose |
| --- | --- | --- |
| `DesignFileRequest` | `@dataclass` | Request with `source_path`, `source_content`, optional `interface_skeleton`, `language`, `existing_design_file`, `available_concepts` |
...
- `lexibrary.baml_client.types` -- `DesignFileOutput`
