...
- **Explore the CLI** -- Read [lexictl Reference](lexictl-reference.md) for every command, flag, and argument.
- **Understand the agent side** -- Read the [Agent Overview](../agent/README.md) to see what AI agents see and how they use the library.
