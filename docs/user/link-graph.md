...
- [Design File Generation](design-file-generation.md) -- The pipeline that builds the link graph
...
- [Concepts Wiki](concepts-wiki.md) -- How concepts are indexed
- [Stack Q&A](stack-qa.md) -- How Stack posts are indexed
- [Agent Search](../agent/search.md) -- How agents use the link graph for accelerated search
- [Agent Lookup Workflow](../agent/lookup-workflow.md) -- How dependents from the link graph appear in `lexi lookup` output
